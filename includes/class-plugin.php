...
namespace Leira_Access\Includes;

use Leira_Access\Admin\Admin;
...
class Plugin
{
	...
	/**
	 * The key to save the access information
	 */
...
//		$this->loader = new Leira_Access_Loader();
	...
	protected function define_admin_hooks()
	{
		 ...
		 * Admin plugin logic
		 */
		$this->admin = new Admin();//Add the admin class instance to the plugin object

		$this->admin->admin_init();

		add_filter('register_block_type_args', function($args, $name) {
			// Add your custom meta as block attributes
			$args['attributes']['_leira_access'] = [
				'type' => 'string',
				'default' => '',
			];
			$args['attributes']['_leira_access_roles'] = [
				'type' => 'array',
				'default' => [],
				'items' => [
					'type' => 'string',
...
//
//			add_action('enqueue_block_editor_assets', [$this->admin, 'enqueue_block_editor_assets']);
...
//				$this->loader->add_filter("manage_{$post_type}_posts_columns", $plugin_admin_post_type,
//					'custom_column_header');
//
//				//Fires for each custom column of a specific post type in the Posts list table.
//				//This action is documented in: wp-admin/includes/class-wp-posts-list-table.php
//				$this->loader->add_action("manage_{$post_type}_posts_custom_column", $plugin_admin_post_type,
//					'custom_column_content', 10, 2);
//			}
...
//			$this->loader->add_action('admin_enqueue_scripts', $plugin_admin_post_type,
//				'admin_enqueue_quick_edit_scripts');
//
//			//add to loader
...
//				$this->loader->add_filter("manage_edit-{$taxonomy}_columns", $plugin_admin_term, 'custom_column_header',
//					10);
//
...
//				$this->loader->add_action("manage_{$taxonomy}_custom_column", $plugin_admin_term,
//					'custom_column_content', 10, 3);
//
...
//			 * Blocks
//			 */
			require_once plugin_dir_path(__DIR__).'admin/class-leira-access-admin-block.php';
			$plugin_admin_block = new \Leira_Access_Admin_Block();

			add_action('enqueue_block_editor_assets', [$plugin_admin_block, 'enqueue_js']);

			add_action('admin_footer', [$plugin_admin_block, 'insert_roles']);
...
//		$this->loader->add_filter('leira_access_menu_item_visibility', $plugin_public_menu, 'filter_menu_item_visible',
//			20, 2);
//
...
//
//		$this->loader->add_filter('widget_comments_args', $plugin_public_widget,
//			'hide_posts_in_recent_comments_widget');
//
//		$this->loader->add_filter('widget_categories_args', $plugin_public_widget,
//			'hide_categories_in_category_widget');
//
...
//		$this->loader->set('public_block', $plugin_public_block);
	 ...
	 *
	 * Uses the Leira_Access_i18n class to set the domain and to register the hook with WordPress.
	 *
	 * @since    1.0.0
	 * @access   protected
	 */
